...
const DetailPeople = () => {
    ...
    <div className="container">
      <div className="card bg-black text-white text-center mb-3 mx-3 mx-md-5 ">
        <div className="row g-0">
          <div className="col-md-4">
            <img src={"https://starwars-visualguide.com/assets/img/characters/" + (id) + ".jpg"} class="img-fluid rounded h-100" alt="Character" style={{ height: "100%" }} />
            ...
            <div className="card-body">
              ...
              <div className="row mt-5 d-flex justify-content-between">
                <div className="col-3 mb-3">
                  <div className=" p-1 rounded h-100 text-center">
                    <h6 className="text-warning">CREATED</h6>
                    <p className="mb-0">{people && people.properties.created}</p>
                  </div>
                </div>
                <div className="col-3 mb-3">
                  <div className=" p-1 rounded h-100 text-center">
                    <h6 className="text-warning">BIRTH YEAR</h6>
                    <p className="mb-0">{people && people.properties.birth_year}</p>
                  </div>
                </div>
                <div className="col-3 mb-3">
                  <div className=" p-1 rounded h-100 text-center">
                    <h6 className="text-warning">EYE COLOR</h6>
                    <p className="mb-0">{people && people.properties.eye_color}</p>
                  </div>
                </div>
                <div className="col-3 mb-3">
                  <div className=" p-1 rounded h-100 text-center">
                    <h6 className="text-warning">SKIN COLOR</h6>
                    <p className="mb-0">{people && people.properties.skin_color}</p>
                  </div>
                </div>
        <div className="card-footer">
            <Link to="/">
            <button className=" col-3 btn btn-dark btn-outline-warning " type="button"> Go Home Here! </button>
            </Link>
