      ...
      <div className="card bg-black text-white text-center mb-3 mx-3 mx-md-5 ">
        <div className="row g-0">
          <div className="col-md-4">
            <img src={"https://starwars-visualguide.com/assets/img/vehicles/" + (id) + ".jpg"} class="img-fluid rounded " alt="vehicle" style={{ height: "100%"}}/>
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <div className="row mt-5 d-flex justify-content-between">
                ...
                <div className="col-3 mb-3">
                  <div className="t p-1 rounded h-100 text-center">
        ...
        <div className="card-footer">
            <Link to="/">
            <button className="col-3 btn btn-dark btn-outline-warning" type="button">Go back <i className="fas fa-chevron-right"></i></button>
            </Link>
